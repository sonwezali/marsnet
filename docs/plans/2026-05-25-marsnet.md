...
- [x] **Step 3: Implement `marsnet/node/protocol.py`**
...
- [x] **Step 1: Implement `marsnet/node/connection_handler.py`**
...
- [x] **Step 1: Implement `marsnet/node/tcp_listener.py`**
...
- [x] **Step 1: Implement `marsnet/node/contact_manager.py`**
...
- [x] **Step 1: Implement `marsnet/node/udp_listener.py`**
...
- [x] **Step 2: Implement `marsnet/node/hello_broadcaster.py`**
...
- [x] **Step 1: Implement `marsnet/node/ttl_reaper.py`**
...
- [x] **Step 3: Implement `marsnet/node/image_assembler.py`**
...
- [x] **Step 1: Implement `marsnet/node/dashboard_reporter.py`**
...
- [x] **Step 1: Implement `marsnet/node/main.py`**
...
- [x] **Step 1: Implement `marsnet/dashboard/server.py`**
...
- [x] **Step 2: Add launch script to `README.md`**
...
- [x] **Step 1: Create `marsnet/dashboard/static/index.html`**
...
- [x] **Step 2: Create `marsnet/dashboard/static/style.css`**
...
- [x] **Step 3: Create `marsnet/dashboard/static/mars.js`**
...
- [x] **Step 1: Create `plans/initial_plan.json`**
...
- [x] **Step 2: Create sample node config files**
...
- [x] **Step 3: Generate shared key once, copy to all nodes**
